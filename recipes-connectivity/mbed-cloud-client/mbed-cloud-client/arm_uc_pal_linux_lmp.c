...
#ifndef ARM_UC_PAL_SCRIPT_LOC
#define ARM_UC_PAL_SCRIPT_LOC "/usr/bin/"
#endif
 ...
 */
ARM_UC_PAAL_UPDATE_CAPABILITIES ARM_UC_PAL_Linux_GetCapabilities_LmP(void)
{
...
arm_ucp_worker_t arm_uc_worker_parameters_active_details = {
    .command = ARM_UC_PAL_SCRIPT_LOC "arm_update_active_details.sh",
    .header   = 1,
    .firmware = 0,
    .location = 0,
    .offset   = 0,
...
arm_ucp_worker_t arm_uc_worker_parameters_activate = {
    .command = ARM_UC_PAL_SCRIPT_LOC "arm_update_activate.sh",
    .header   = 1,
    .firmware = 1,
    .location = 0,
    .offset   = 0,
...
arm_uc_error_t ARM_UC_PAL_Linux_Initialize_LmP(ARM_UC_PAAL_UPDATE_SignalEvent_t callback)
{
...
const ARM_UC_PAAL_UPDATE ARM_UCP_LINUX_LMP = {
    .Initialize                 = ARM_UC_PAL_Linux_Initialize_LmP,
    .GetCapabilities            = ARM_UC_PAL_Linux_GetCapabilities_LmP,
